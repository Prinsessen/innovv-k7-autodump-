...
2. If no WiFi available, Shelly creates AP: `ShellyPlusUni-A1B2C3D4E5F6`
...
```openhab
Thing shelly:shellyplusuni:a1b2c3d4e5f6 "Shelly Plus Uni (Motorcycle K7)" @ "Garage" [
    deviceIp="192.168.1.62"
]
```

**Thing UID**: `shelly:shellyplusuni:a1b2c3d4e5f6`
...
- Check BLE pairing: `bluetoothctl info AA:BB:CC:DD:EE:FF` on Pi
